...
const th: NativeMessages = {
  ...
  updaterAvailableTitle: 'พบอัปเดต - inwsus',
  ok: 'ตกลง',
  shutdownBlockedTitle: 'inwsus ยังทำงานอยู่',
  shutdownBlockedMessage: 'ยังยืนยันไม่ได้ว่า Tunnel ที่ inwsus ดูแลหยุดทำงานแล้ว โปรแกรมจะยังเปิดอยู่ กรุณาตรวจสอบสถานะ Tunnel แล้วลองปิดโปรแกรมอีกครั้ง',
  updateAvailableStatus: (version) => `พบ v${version} — กำลังดาวน์โหลดในเบื้องหลัง`,
  updateAvailableDialog: (version) => `พบ inwsus v${version} กำลังดาวน์โหลดอัปเดตในเบื้องหลัง`,
  ...
  updateCurrentDialog: (version) => `inwsus v${version} เป็นเวอร์ชันล่าสุดแล้ว`,
...
const en: NativeMessages = {
  ...
  updaterAvailableTitle: 'Update Available - inwsus',
  ok: 'OK',
  shutdownBlockedTitle: 'inwsus is still running',
  shutdownBlockedMessage: 'The owned tunnel could not be confirmed stopped. inwsus will remain open; check the tunnel status and retry Quit.',
  updateAvailableStatus: (version) => `v${version} found — downloading in the background`,
  updateAvailableDialog: (version) => `inwsus v${version} is available and is downloading in the background`,
  ...
  updateCurrentDialog: (version) => `inwsus v${version} is up to date`,
