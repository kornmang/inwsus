      ...
      {section === 'tools' ? (
        <>
          ...
          <section className="panel settings-card settings-card-polished" aria-label="Tools and timeouts">
            <CardHeading icon="⌛" title={locale === 'th' ? 'Timeout และ Local MCP' : 'Timeouts & Local MCP'} subtitle={locale === 'th' ? 'เวลารอสำหรับ external tools และ process ที่จัดการโดย inwsus' : 'Execution limits for external tools and managed processes'} />
            <div className="setting-grid two-col">
