...
export const th: Messages = {
  ...
  'tunnel.needProfile': 'ยังไม่มีโปรไฟล์ inwsus.yaml',
  ...
  'project.systemHint': 'Workspace นี้ inwsus จัดการอัตโนมัติ จึงไม่สามารถเก็บถาวรหรือลบได้',
  'project.emptyActive': 'ยังไม่มีโปรเจกต์ที่ใช้งานอยู่',
  'project.emptyArchived': 'ยังไม่มีโปรเจกต์ที่เก็บถาวร',
  'project.deleteHint': 'ลบเฉพาะรายการออกจาก inwsus เท่านั้น — โฟลเดอร์ ไฟล์ และ Git ของโปรเจกต์จะไม่ถูกลบ',
  ...
  'live.waitingTunnel': 'ยังไม่มีไฟล์ tunnel log — รัน tunnel ด้วยสคริปต์ start-inwsus-tunnel.ps1 หรือกด Start Tunnel',
...
export const en: Messages = {
  ...
  'tunnel.needProfile': 'Missing inwsus.yaml tunnel profile',
  ...
  'project.systemHint': 'This workspace is managed automatically by inwsus and cannot be archived or removed.',
  'project.emptyActive': 'No active projects yet.',
  'project.emptyArchived': 'No archived projects.',
  'project.deleteHint': 'Removes only the inwsus registration — the project folder, files, and Git repository are not deleted.',
  'info.workspace': 'Workspace',
  'info.activeProject': 'Active Project',
  'info.mode': 'Mode',
  ...
  'live.waitingTunnel': 'No tunnel log file yet — run start-inwsus-tunnel.ps1 or press Start Tunnel',
